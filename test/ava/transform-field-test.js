...
import {transformField} from '../../src/index.js'
...
test('transformField: object', (t) => {
  t.deepEqual(
    transformField({
      ...
      field: 'anObject',
      transformer: (field) =>
        field.anotherField === 'val-2' ? _.set(field, 'anotherField', 'val-3') : field,
    }),
    {
      aField: 'val-1',
      anObject: {
...
test('transformField: empty object', (t) => {
  t.deepEqual(
    transformField({
      ...
      field: 'anObject',
      transformer: (field) =>
        field.anotherField === 'val-2' ? _.omit(field, 'anotherField') : field,
    }),
    {
      aField: 'val-1',
    },
